using hw_CardGameMiniProject.Enums;
using hw_CardGameMiniProject.Models;

namespace hw_CardGameMiniProject;
...
public abstract class Deck
{
    ...
    protected void CreateDeck()
    {
        ...
        int valuesCount = Enum.GetValues(typeof(CardValue)).Length;

        for (int suit = 0; suit < suitsCount; suit++)
        {
            for(int val = 0; val < valuesCount; val++)
            {
