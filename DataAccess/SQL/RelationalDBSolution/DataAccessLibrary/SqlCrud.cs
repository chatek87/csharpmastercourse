...
public class SqlCrud
{
    ...
    public FullContactModel GetFullContactById(int id)
    {
        ...
        {
            // do something to tell user that record wasn't found
            //throw new Exception("User not found");    // could do this too and handle exception
            return null;
        }
    ...
    {
        // Find all of teh usages of the phone number id

        // if only one use, delete number from phonenumbers table
        // if more than one use, remove the contactphonenumbers record that links the contact with the phone number in question
